<script lang='ts'>
    import SignupImage from "$lib/assets/signup.jpg";
    import { enhance } from '$app/forms'
	
</script>

<div class="w-full min-h-[100vh] py-10 flex justify-evenly pt-[4%]">
    <form method="POST" action="?/register"  class="ml-0 border-2 border-white/20 flex flex-col lg:flex-row p-0 h-max lg:min-h-[26rem] !max-w-[50rem] bg-slate-800 rounded-lg">
